...
// Add child elements to the XML document
$xml->addChild('nama', $row['nama']);
$xml->addChild('harga', $row['harga']);
$xml->addChild('deskripsi', $row['deskripsi']);

// Save the XML document to a file
$xmlFile = 'deatil_produk.xml';
$xml->asXML($xmlFile);
